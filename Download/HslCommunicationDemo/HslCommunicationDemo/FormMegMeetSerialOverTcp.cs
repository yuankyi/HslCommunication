...
{
	public class FormMegMeetSerialOverTcp : HslFormContent
	{
		private MegMeetSerialOverTcp megMeet = null;
		...
		public FormMegMeetSerialOverTcp()
		{
			InitializeComponent();
		}
		...
		private void Language(int language)
		{
			if (language == 2)
			{
				Text = "MegMeetSerial OverTcp Read Demo";
				label1.Text = "Ip:";
				label3.Text = "Port:";
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				MegMeetSerialOverTcp megMeetSerialOverTcp = megMeet;
				if (megMeetSerialOverTcp != null)
				{
					megMeetSerialOverTcp.ConnectClose();
				}
				megMeet = new MegMeetSerialOverTcp(textBox1.Text, result, result2);
				...
				try
				{
					OperateResult operateResult = megMeet.ConnectServer();
					if (operateResult.IsSuccess)
					{
						...
						panel2.Enabled = true;
						userControlReadWriteOp1.SetReadWriteNet(megMeet, "M100", true);
					}
					else
					{
		...
		{
			OperateResult<byte[]> operateResult = megMeet.ReadFromCoreServer(SoftBasic.HexStringToBytes(textBox13.Text));
			if (operateResult.IsSuccess)
			{
		...
		private void thread_test2()
		{
			...
			{
				if (!megMeet.Write("100", (short)1234).IsSuccess)
				{
					failed++;
				}
				if (!megMeet.ReadInt16("100").IsSuccess)
				{
					failed++;
				}
			}
		...
		private void InitializeComponent()
		{
			...
			comboBox1.Location = new System.Drawing.Point(558, 13);
			...
			checkBox3.Location = new System.Drawing.Point(653, 16);
			...
			base.Name = "FormMegMeetSerialOverTcp";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "MegMeetSerialOverTcp访问Demo";
