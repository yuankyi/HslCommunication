...
{
	public class FormKeyenceAscii : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				keyence_net.Port = result;
				keyence_net.ConnectClose();
				keyence_net.LogNet = base.LogNet;
				try
				{
					OperateResult operateResult = keyence_net.ConnectServer();
		...
		{
			OperateResult<byte[]> operateResult = keyence_net.ReadFromCoreServer(SoftBasic.HexStringToBytes(textBox13.Text));
			if (operateResult.IsSuccess)
			{
		...
		private void test1()
		{
			OperateResult<bool[]> operateResult = keyence_net.ReadBool("M100", 10);
			if (operateResult.IsSuccess)
			{
		...
		private void test2()
		{
			...
			OperateResult operateResult = keyence_net.Write("M100", value);
			if (!operateResult.IsSuccess)
			{
			}
		}
		...
		private void test3()
		{
			short content = keyence_net.ReadInt16("D100").Content;
			ushort content2 = keyence_net.ReadUInt16("D100").Content;
			int content3 = keyence_net.ReadInt32("D100").Content;
			uint content4 = keyence_net.ReadUInt32("D100").Content;
			long content5 = keyence_net.ReadInt64("D100").Content;
			ulong content6 = keyence_net.ReadUInt64("D100").Content;
			float content7 = keyence_net.ReadFloat("D100").Content;
			double content8 = keyence_net.ReadDouble("D100").Content;
			string content9 = keyence_net.ReadString("D100", 10).Content;
		}
		...
		private void test4()
		{
			...
			keyence_net.Write("D100", 5u);
			keyence_net.Write("D100", 5L);
			keyence_net.Write("D100", 5uL);
			keyence_net.Write("D100", 5f);
			keyence_net.Write("D100", 5.0);
			keyence_net.Write("D100", "12345678");
		}

		private void test5()
		{
			OperateResult<byte[]> operateResult = keyence_net.Read("D100", 10);
			if (operateResult.IsSuccess)
			{
				int num = keyence_net.ByteTransform.TransInt32(operateResult.Content, 0);
				float num2 = keyence_net.ByteTransform.TransSingle(operateResult.Content, 4);
				short num3 = keyence_net.ByteTransform.TransInt16(operateResult.Content, 8);
		...
		private void test6()
		{
			OperateResult<UserType> operateResult = keyence_net.ReadCustomer<UserType>("D100");
			if (operateResult.IsSuccess)
			{
				UserType content = operateResult.Content;
			}
			keyence_net.WriteCustomer("D100", new UserType());
			keyence_net.LogNet = new LogNetSingle(Application.StartupPath + "\\Logs.txt");
		}
		...
		private void thread_test2()
		{
			...
			{
				if (!keyence_net.Write("D100", (short)1234).IsSuccess)
				{
					failed++;
				}
				if (!keyence_net.ReadInt16("D100").IsSuccess)
				{
					failed++;
				}
			}
		...
		private void thread_end()
		{
			if (Interlocked.Decrement(ref thread_status) == 0)
			{
				Invoke((Action)delegate
				{
					...
					MessageBox.Show("Spend：" + (DateTime.Now - thread_time_start).TotalSeconds.ToString() + Environment.NewLine + " Faield Count：" + failed.ToString());
				});
			}
		}
		...
		{
			OperateResult operateResult = keyence_net.RemoteRun();
			if (operateResult.IsSuccess)
			{
		...
		{
			OperateResult operateResult = keyence_net.RemoteStop();
			if (operateResult.IsSuccess)
			{
		...
		{
			OperateResult<string> operateResult = keyence_net.ReadPlcType();
			if (operateResult.IsSuccess)
			{
		...
		private void InitializeComponent()
		{
			...
			label22.TabIndex = 7;
			label22.Text = "M100 D100 X1A0 Y1A0 详细说明参照博客";
			...
			textBox14.Location = new System.Drawing.Point(12, 101);
			textBox14.Multiline = true;
			textBox14.Name = "textBox14";
			textBox14.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
			textBox14.Size = new System.Drawing.Size(401, 137);
			...
			groupBox4.Size = new System.Drawing.Size(565, 151);
			...
			textBox11.Size = new System.Drawing.Size(496, 85);
			...
			button26.Location = new System.Drawing.Point(477, 24);
			...
			textBox13.Size = new System.Drawing.Size(408, 23);
			...
			groupBox3.Size = new System.Drawing.Size(565, 154);
			...
			button6.Location = new System.Drawing.Point(389, 24);
			...
			textBox10.Size = new System.Drawing.Size(496, 88);
			...
			userControlHead1.ProtocolInfo = "MC  Qna3E ASCII";
