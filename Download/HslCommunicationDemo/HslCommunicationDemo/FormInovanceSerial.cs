...
{
	public class FormInovanceSerial : HslFormContent
	{
		...
		private void ComboBox2_SelectedIndexChanged(object sender, EventArgs e)
		{
			if (inovance != null)
			{
				...
				{
				case 0:
					inovance.DataFormat = DataFormat.ABCD;
					break;
				case 1:
					inovance.DataFormat = DataFormat.BADC;
					break;
				case 2:
					inovance.DataFormat = DataFormat.CDAB;
					break;
				case 3:
					inovance.DataFormat = DataFormat.DCBA;
					break;
				}
			}
		}
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				InovanceSerial inovanceSerial = inovance;
				if (inovanceSerial != null)
				{
					inovanceSerial.Close();
				}
				inovance = new InovanceSerial(result);
				inovance.AddressStartWithZero = checkBox1.Checked;
				inovance.Series = (InovanceSeries)comboBox4.SelectedItem;
				inovance.LogNet = base.LogNet;
				ComboBox2_SelectedIndexChanged(null, new EventArgs());
				inovance.IsStringReverse = checkBox3.Checked;
				try
				{
					inovance.SerialPortInni(delegate(SerialPort sp)
					{
					...
					panel2.Enabled = true;
					userControlReadWriteOp1.SetReadWriteNet(inovance, "M100");
				}
				catch (Exception ex)
				{
		...
		{
			OperateResult<byte[]> operateResult = inovance.ReadFromCoreServer(SoftCRC16.CRC16(SoftBasic.HexStringToBytes(textBox13.Text)));
		...
		public override void SaveXmlParameter(XElement element)
		{
			...
			element.SetAttributeValue("InovanceSeries", (InovanceSeries)comboBox4.SelectedItem);
		}
		...
		public override void LoadXmlParameter(XElement element)
		{
			...
			if (element.Attribute("InovanceSeries") != null)
			{
				comboBox4.SelectedItem = SoftBasic.GetEnumFromString<InovanceSeries>(element.Attribute("InovanceSeries").Value);
			}
		}
		...
		private void InitializeComponent()
		{
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(1002, 64);
			panel1.TabIndex = 0;
			...
			comboBox4.Location = new System.Drawing.Point(645, 4);
			comboBox4.Name = "comboBox4";
			comboBox4.Size = new System.Drawing.Size(65, 25);
			comboBox4.TabIndex = 36;
			label2.AutoSize = true;
			label2.Location = new System.Drawing.Point(592, 8);
			label2.Name = "label2";
			label2.Size = new System.Drawing.Size(44, 17);
			label2.TabIndex = 35;
			label2.Text = "系列：";
			checkBox5.AutoSize = true;
			checkBox5.Location = new System.Drawing.Point(235, 37);
			...
			comboBox3.Location = new System.Drawing.Point(61, 4);
			...
			comboBox2.Location = new System.Drawing.Point(323, 34);
			...
			textBox2.Location = new System.Drawing.Point(195, 4);
			textBox2.Name = "textBox2";
			textBox2.Size = new System.Drawing.Size(47, 23);
			textBox2.TabIndex = 3;
			textBox2.Text = "9600";
			label3.AutoSize = true;
			label3.Location = new System.Drawing.Point(134, 7);
			label3.Name = "label3";
			...
			label24.Location = new System.Drawing.Point(469, 7);
			label24.Name = "label24";
			label24.Size = new System.Drawing.Size(44, 17);
			label24.TabIndex = 14;
			label24.Text = "奇偶：";
			checkBox3.AutoSize = true;
			checkBox3.Location = new System.Drawing.Point(423, 37);
			...
			panel2.Name = "panel2";
			panel2.Size = new System.Drawing.Size(1002, 550);
			panel2.TabIndex = 1;
			...
			userControlReadWriteOp1.Size = new System.Drawing.Size(994, 240);
			...
			groupBox5.Location = new System.Drawing.Point(577, 243);
			groupBox5.Name = "groupBox5";
			groupBox5.Size = new System.Drawing.Size(420, 291);
			...
			textBox12.Size = new System.Drawing.Size(396, 202);
			...
			groupBox4.Size = new System.Drawing.Size(568, 131);
			...
			textBox11.Size = new System.Drawing.Size(499, 65);
			...
			groupBox3.Size = new System.Drawing.Size(568, 154);
			...
			textBox10.Size = new System.Drawing.Size(499, 88);
			...
			button25.Location = new System.Drawing.Point(480, 24);
			...
			userControlHead1.Size = new System.Drawing.Size(1009, 32);
			...
			AutoScroll = true;
			base.ClientSize = new System.Drawing.Size(1009, 656);
			base.Controls.Add(userControlHead1);
			base.Controls.Add(panel2);
			base.Controls.Add(panel1);
			Font = new System.Drawing.Font("微软雅黑", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
			base.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			base.Name = "FormInovanceSerial";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "Inovance Serial访问Demo";
