...
{
	public class FormMegMeetSerial : HslFormContent
	{
		...
		private void ComboBox2_SelectedIndexChanged(object sender, EventArgs e)
		{
			if (megMeet != null)
			{
				...
				{
				case 0:
					megMeet.DataFormat = DataFormat.ABCD;
					break;
				case 1:
					megMeet.DataFormat = DataFormat.BADC;
					break;
				case 2:
					megMeet.DataFormat = DataFormat.CDAB;
					break;
				case 3:
					megMeet.DataFormat = DataFormat.DCBA;
					break;
				}
			}
		}
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				MegMeetSerial megMeetSerial = megMeet;
				if (megMeetSerial != null)
				{
					megMeetSerial.Close();
				}
				megMeet = new MegMeetSerial(result);
				megMeet.AddressStartWithZero = checkBox1.Checked;
				megMeet.LogNet = base.LogNet;
				ComboBox2_SelectedIndexChanged(null, new EventArgs());
				megMeet.IsStringReverse = checkBox3.Checked;
				try
				{
					megMeet.SerialPortInni(delegate(SerialPort sp)
					{
					...
					panel2.Enabled = true;
					userControlReadWriteOp1.SetReadWriteNet(megMeet, "M100");
				}
				catch (Exception ex)
				{
		...
		{
			DemoUtils.BulkReadRenderResult(megMeet, textBox6, textBox9, textBox10);
		}

		private void button26_Click(object sender, EventArgs e)
		{
			OperateResult<byte[]> operateResult = megMeet.ReadFromCoreServer(SoftCRC16.CRC16(SoftBasic.HexStringToBytes(textBox13.Text)));
		...
		private void InitializeComponent()
		{
			...
			base.Name = "FormMegMeetSerial";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "MegMeet Serial访问Demo";
