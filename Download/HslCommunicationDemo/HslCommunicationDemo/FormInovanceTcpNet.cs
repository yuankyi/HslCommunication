...
{
	public class FormInovanceTcpNet : HslFormContent
	{
		...
		private void ComboBox1_SelectedIndexChanged(object sender, EventArgs e)
		{
			if (inovanceH3UTcp != null)
			{
				...
				{
				case 0:
					inovanceH3UTcp.DataFormat = DataFormat.ABCD;
					break;
				case 1:
					inovanceH3UTcp.DataFormat = DataFormat.BADC;
					break;
				case 2:
					inovanceH3UTcp.DataFormat = DataFormat.CDAB;
					break;
				case 3:
					inovanceH3UTcp.DataFormat = DataFormat.DCBA;
					break;
				}
			}
		}
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				InovanceTcpNet inovanceTcpNet = inovanceH3UTcp;
				if (inovanceTcpNet != null)
				{
					inovanceTcpNet.ConnectClose();
				}
				inovanceH3UTcp = new InovanceTcpNet(textBox1.Text, result, result2);
				...
				inovanceH3UTcp.IsStringReverse = checkBox3.Checked;
				inovanceH3UTcp.LogNet = base.LogNet;
				try
				{
					OperateResult operateResult = inovanceH3UTcp.ConnectServer();
		...
		{
			OperateResult<byte[]> operateResult = inovanceH3UTcp.ReadFromCoreServer(SoftBasic.HexStringToBytes(textBox13.Text));
			if (operateResult.IsSuccess)
			{
		...
		private void thread_test2()
		{
			...
			{
				if (!inovanceH3UTcp.Write("100", (short)1234).IsSuccess)
				{
					failed++;
				}
				if (!inovanceH3UTcp.ReadInt16("100").IsSuccess)
				{
					failed++;
				}
			}
		...
		private void InitializeComponent()
		{
			...
			comboBox4.Location = new System.Drawing.Point(361, 32);
			comboBox4.Name = "comboBox4";
			comboBox4.Size = new System.Drawing.Size(65, 25);
			comboBox4.TabIndex = 40;
			label2.AutoSize = true;
			label2.Location = new System.Drawing.Point(308, 36);
			label2.Name = "label2";
			...
			comboBox1.Location = new System.Drawing.Point(558, 2);
			comboBox1.Name = "comboBox1";
			comboBox1.Size = new System.Drawing.Size(89, 25);
			comboBox1.TabIndex = 26;
			checkBox1.AutoSize = true;
			checkBox1.Checked = true;
			checkBox1.CheckState = System.Windows.Forms.CheckState.Checked;
			checkBox1.Location = new System.Drawing.Point(447, 5);
			checkBox1.Name = "checkBox1";
			checkBox1.Size = new System.Drawing.Size(106, 21);
			checkBox1.TabIndex = 9;
			checkBox1.Text = "首地址从0开始";
			checkBox1.UseVisualStyleBackColor = true;
			textBox15.Location = new System.Drawing.Point(392, 3);
			textBox15.Name = "textBox15";
			textBox15.Size = new System.Drawing.Size(39, 23);
			textBox15.TabIndex = 7;
			textBox15.Text = "1";
			label21.AutoSize = true;
			label21.Location = new System.Drawing.Point(338, 6);
			...
			checkBox3.Location = new System.Drawing.Point(653, 4);
			...
			groupBox4.Size = new System.Drawing.Size(563, 135);
			...
			base.Name = "FormInovanceTcpNet";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "InovanceTcp访问Demo";
