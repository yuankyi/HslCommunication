...
{
	public class FormModbusRtuOverTcp : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				ModbusRtuOverTcp modbusRtuOverTcp = busTcpClient;
				if (modbusRtuOverTcp != null)
				{
					modbusRtuOverTcp.ConnectClose();
				}
				busTcpClient = new ModbusRtuOverTcp(textBox1.Text, result, result2);
		...
		private void InitializeComponent()
		{
			...
			checkBox3.Location = new System.Drawing.Point(657, 12);
			...
			textBox14.Size = new System.Drawing.Size(396, 201);
			textBox14.TabIndex = 24;
			button3.Location = new System.Drawing.Point(229, 269);
			...
			groupBox4.Size = new System.Drawing.Size(564, 148);
			...
			textBox11.Size = new System.Drawing.Size(495, 82);
			...
			userControlHead1.ProtocolInfo = "Modbus Rtu OverTcp";
			...
			base.Name = "FormModbusRtuOverTcp";
