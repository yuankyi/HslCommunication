...
{
	public class FormKukaTcp : HslFormContent
	{
		[CompilerGenerated]
		private sealed class _003Cbutton14_Click_003Ed__8 : IAsyncStateMachine
		{
			...
			public FormKukaTcp _003C_003E4__this;
		...
		private sealed class _003Cbutton1_Click_003Ed__5 : IAsyncStateMachine
		{
			...
			private void MoveNext()
			{
				...
				try
				{
					...
					{
						KukaTcpNet kuka = _003C_003E4__this.kuka;
						if (kuka != null)
						{
							kuka.ConnectClose();
						}
						_003C_003E4__this.kuka = new KukaTcpNet(_003C_003E4__this.textBox1.Text, _003Cport_003E5__1);
						goto IL_007f;
					}
		...
		private sealed class _003Cbutton3_Click_003Ed__9 : IAsyncStateMachine
		{
			...
			private void MoveNext()
			{
				...
				try
				{
					...
					if (num != 0)
					{
						awaiter = _003C_003E4__this.kuka.StartProgramAsync(_003C_003E4__this.textBox5.Text).GetAwaiter();
						if (!awaiter.IsCompleted)
						{
							num = (_003C_003E1__state = 0);
							_003C_003Eu__1 = awaiter;
					...
					{
						MessageBox.Show("Start Failed:" + _003Cresult_003E5__1.Message);
					}
				}
				catch (Exception exception)
				{
		...
		private sealed class _003Cbutton4_Click_003Ed__10 : IAsyncStateMachine
		{
			...
			private void MoveNext()
			{
				...
				try
				{
					...
					if (num != 0)
					{
						awaiter = _003C_003E4__this.kuka.ResetProgramAsync().GetAwaiter();
						if (!awaiter.IsCompleted)
						{
							num = (_003C_003E1__state = 0);
							_003C_003Eu__1 = awaiter;
					...
					{
						MessageBox.Show("Reset Failed:" + _003Cresult_003E5__1.Message);
					}
				}
				catch (Exception exception)
				{
		...
		private sealed class _003Cbutton5_Click_003Ed__11 : IAsyncStateMachine
		{
			...
			private void MoveNext()
			{
				...
				try
				{
					...
					if (num != 0)
					{
						awaiter = _003C_003E4__this.kuka.StopProgramAsync().GetAwaiter();
						if (!awaiter.IsCompleted)
						{
							num = (_003C_003E1__state = 0);
							_003C_003Eu__1 = awaiter;
		...
		private void InitializeComponent()
		{
			...
			pictureBox1.Image = HslCommunicationDemo.Properties.Resources.kuka_help;
			pictureBox1.Location = new System.Drawing.Point(12, 292);
			pictureBox1.Name = "pictureBox1";
			pictureBox1.Size = new System.Drawing.Size(238, 226);
			...
			label4.Name = "label4";
			label4.Size = new System.Drawing.Size(276, 17);
			label4.TabIndex = 22;
			label4.Text = "如果你有什么问题，可以加下面的kuka专家咨询：";
			button5.Location = new System.Drawing.Point(307, 216);
			...
			button4.Location = new System.Drawing.Point(307, 182);
			...
			button3.Location = new System.Drawing.Point(307, 148);
			...
			textBox5.Location = new System.Drawing.Point(63, 151);
			textBox5.Name = "textBox5";
			textBox5.Size = new System.Drawing.Size(227, 23);
			textBox5.TabIndex = 18;
			textBox5.Text = "MAIN";
			label2.AutoSize = true;
			label2.Location = new System.Drawing.Point(9, 154);
			label2.Name = "label2";
			...
			userControlHead1.ProtocolInfo = "KUKA TCP";
