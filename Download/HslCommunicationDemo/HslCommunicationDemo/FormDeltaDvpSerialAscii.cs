...
{
	public class FormDeltaDvpSerialAscii : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				DeltaSerialAscii deltaSerialAscii = delta;
				if (deltaSerialAscii != null)
				{
					deltaSerialAscii.Close();
				}
				delta = new DeltaSerialAscii(result);
				delta.LogNet = base.LogNet;
				delta.Series = (DeltaSeries)comboBox2.SelectedItem;
				try
				{
					delta.SerialPortInni(delegate(SerialPort sp)
					{
					...
					panel2.Enabled = true;
					userControlReadWriteOp1.SetReadWriteNet(delta, "D100");
				}
				catch (Exception ex)
				{
		...
		{
			OperateResult<byte[]> operateResult = delta.ReadFromCoreServer(SoftCRC16.CRC16(SoftBasic.HexStringToBytes(textBox13.Text)));
		...
		private void InitializeComponent()
		{
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(1014, 66);
			panel1.TabIndex = 0;
			comboBox2.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			comboBox2.FormattingEnabled = true;
			comboBox2.Location = new System.Drawing.Point(307, 34);
			comboBox2.Name = "comboBox2";
			comboBox2.Size = new System.Drawing.Size(86, 25);
			comboBox2.TabIndex = 32;
			label2.AutoSize = true;
			label2.Location = new System.Drawing.Point(248, 38);
			label2.Name = "label2";
			label2.Size = new System.Drawing.Size(44, 17);
			label2.TabIndex = 31;
			label2.Text = "系列：";
			checkBox5.AutoSize = true;
			checkBox5.Location = new System.Drawing.Point(120, 37);
			...
			label21.Text = "站号：";
			button2.Enabled = false;
			button2.Location = new System.Drawing.Point(683, 16);
			...
			button1.Location = new System.Drawing.Point(586, 16);
			...
			panel2.Name = "panel2";
			panel2.Size = new System.Drawing.Size(1014, 529);
			panel2.TabIndex = 1;
			...
			userControlReadWriteOp1.Size = new System.Drawing.Size(1006, 240);
			...
			groupBox5.Location = new System.Drawing.Point(589, 243);
			...
			groupBox4.Size = new System.Drawing.Size(580, 131);
			...
			textBox11.Size = new System.Drawing.Size(511, 65);
			...
			button26.Location = new System.Drawing.Point(492, 24);
			...
			textBox13.Size = new System.Drawing.Size(423, 23);
			...
			groupBox3.Size = new System.Drawing.Size(580, 154);
			...
			textBox10.Size = new System.Drawing.Size(511, 88);
			...
			button25.Location = new System.Drawing.Point(492, 24);
			...
			userControlHead1.Size = new System.Drawing.Size(1021, 32);
			...
			AutoScroll = true;
			base.ClientSize = new System.Drawing.Size(1021, 635);
			base.Controls.Add(userControlHead1);
			base.Controls.Add(panel2);
			base.Controls.Add(panel1);
			Font = new System.Drawing.Font("微软雅黑", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
			base.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			base.Name = "FormDeltaDvpSerialAscii";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "台达 Dvp 串口访问Demo";
