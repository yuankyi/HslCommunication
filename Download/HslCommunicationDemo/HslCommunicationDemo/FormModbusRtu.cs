...
{
	public class FormModbusRtu : HslFormContent
	{
		...
		private CheckBox checkBox_crc16;
		...
		private void ComboBox2_SelectedIndexChanged(object sender, EventArgs e)
		{
			if (busRtuClient != null)
			{
				...
				{
				case 0:
					busRtuClient.DataFormat = DataFormat.ABCD;
					break;
				case 1:
					busRtuClient.DataFormat = DataFormat.BADC;
					break;
				case 2:
					busRtuClient.DataFormat = DataFormat.CDAB;
					break;
				case 3:
					busRtuClient.DataFormat = DataFormat.DCBA;
					break;
				}
			}
		}
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				...
				try
				{
					...
					panel2.Enabled = true;
					userControlReadWriteOp1.SetReadWriteNet(busRtuClient, "100");
				}
				catch (Exception ex)
				{
		...
		{
			OperateResult<byte[]> operateResult = busRtuClient.ReadFromCoreServer(textBox13.Text.ToHexBytes());
		...
		private void InitializeComponent()
		{
			...
			checkBox_crc16 = new System.Windows.Forms.CheckBox();
			...
			panel1.Controls.Add(checkBox_crc16);
			...
			panel1.TabIndex = 0;
			checkBox_crc16.AutoSize = true;
			checkBox_crc16.Checked = true;
			checkBox_crc16.CheckState = System.Windows.Forms.CheckState.Checked;
			checkBox_crc16.Location = new System.Drawing.Point(225, 34);
			checkBox_crc16.Name = "checkBox_crc16";
			checkBox_crc16.Size = new System.Drawing.Size(99, 21);
			checkBox_crc16.TabIndex = 32;
			checkBox_crc16.Text = "Crc16 Check";
			checkBox_crc16.UseVisualStyleBackColor = true;
			checkBox2.AutoSize = true;
			checkBox2.Location = new System.Drawing.Point(577, 34);
			checkBox2.Name = "checkBox2";
			checkBox2.Size = new System.Drawing.Size(135, 21);
			checkBox2.TabIndex = 31;
			checkBox2.Text = "读取前是否清空缓存";
			checkBox2.UseVisualStyleBackColor = true;
			checkBox5.AutoSize = true;
			checkBox5.Location = new System.Drawing.Point(675, 5);
			...
			comboBox1.Location = new System.Drawing.Point(577, 3);
			...
			checkBox1.Location = new System.Drawing.Point(99, 34);
			...
			label21.Text = "站号：";
			button2.Enabled = false;
			button2.Location = new System.Drawing.Point(871, 15);
			...
			button1.Location = new System.Drawing.Point(765, 15);
			...
			label24.Location = new System.Drawing.Point(539, 6);
			...
			groupBox5.Size = new System.Drawing.Size(420, 293);
			...
			groupBox4.Size = new System.Drawing.Size(561, 133);
			...
			textBox11.Size = new System.Drawing.Size(492, 67);
