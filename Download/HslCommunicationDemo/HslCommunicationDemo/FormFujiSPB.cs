...
{
	public class FormFujiSPB : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				...
				try
				{
					fujiSPB.SerialPortInni(delegate(SerialPort sp)
					{
					...
					panel2.Enabled = true;
					userControlReadWriteOp1.SetReadWriteNet(fujiSPB, "M100");
				}
				catch (Exception ex)
				{
		...
		private void InitializeComponent()
		{
			...
			textBox15.Location = new System.Drawing.Point(640, 9);
			textBox15.Name = "textBox15";
			textBox15.Size = new System.Drawing.Size(31, 23);
			textBox15.TabIndex = 28;
			textBox15.Text = "0";
			label21.AutoSize = true;
			label21.Location = new System.Drawing.Point(593, 12);
			...
			label27.Text = "Com口：";
			button2.Enabled = false;
			button2.Location = new System.Drawing.Point(790, 6);
			...
			button1.Location = new System.Drawing.Point(693, 6);
			...
			groupBox4.Size = new System.Drawing.Size(563, 149);
			...
			textBox11.Size = new System.Drawing.Size(494, 83);
			...
			userControlHead1.ProtocolInfo = "SPB";
