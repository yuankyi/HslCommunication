...
{
	public class FormRkcTemperatureControllerOverTcp : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				TemperatureControllerOverTcp temperatureControllerOverTcp = rkc;
				if (temperatureControllerOverTcp != null)
				{
					temperatureControllerOverTcp.ConnectClose();
				}
				...
				try
				{
					OperateResult operateResult = rkc.ConnectServer();
		...
		{
			OperateResult<byte[]> operateResult = rkc.ReadFromCoreServer(SoftCRC16.CRC16(SoftBasic.HexStringToBytes(textBox13.Text)));
			if (operateResult.IsSuccess)
			{
		...
		private void InitializeComponent()
		{
			...
			groupBox4.Size = new System.Drawing.Size(537, 140);
			...
			textBox11.Size = new System.Drawing.Size(468, 74);
			...
			textBox10.Location = new System.Drawing.Point(63, 57);
			textBox10.Multiline = true;
			textBox10.Name = "textBox10";
			textBox10.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
			textBox10.Size = new System.Drawing.Size(468, 91);
			textBox10.TabIndex = 10;
			label13.AutoSize = true;
			label13.Location = new System.Drawing.Point(9, 59);
			label13.Name = "label13";
			label13.Size = new System.Drawing.Size(44, 17);
			label13.TabIndex = 9;
			label13.Text = "结果：";
			button25.Enabled = false;
			button25.Location = new System.Drawing.Point(426, 21);
			...
			userControlHead1.ProtocolInfo = "RKC OverTcp";
			...
			base.Name = "FormRkcTemperatureControllerOverTcp";
