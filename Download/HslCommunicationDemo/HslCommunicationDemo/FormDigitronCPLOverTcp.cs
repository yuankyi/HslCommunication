...
{
	public class FormDigitronCPLOverTcp : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				DigitronCPLOverTcp digitronCPLOverTcp = cpl;
				if (digitronCPLOverTcp != null)
				{
					digitronCPLOverTcp.ConnectClose();
				}
				...
				try
				{
					OperateResult operateResult = cpl.ConnectServer();
		...
		{
			OperateResult<byte[]> operateResult = cpl.ReadFromCoreServer(SoftCRC16.CRC16(SoftBasic.HexStringToBytes(textBox13.Text)));
			if (operateResult.IsSuccess)
			{
		...
		private void InitializeComponent()
		{
			...
			userControlHead1.ProtocolInfo = "CPL OverTcp";
			...
			base.Name = "FormDigitronCPLOverTcp";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "山武 数字指示调节器CPL访问Demo";
