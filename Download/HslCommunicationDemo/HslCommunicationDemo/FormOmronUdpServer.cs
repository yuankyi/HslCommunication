...
{
	public class FormOmronUdpServer : HslFormContent
	{
		private OmronFinsUdpServer omronFinsServer;
		...
		{
			OmronFinsUdpServer omronFinsUdpServer = omronFinsServer;
			if (omronFinsUdpServer != null)
			{
				omronFinsUdpServer.ServerClose();
			}
		}
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				try
				{
					omronFinsServer = new OmronFinsUdpServer();
		...
		private void InitializeComponent()
		{
			...
			userControlHead1.ProtocolInfo = "Fins Udp Server";
			...
			base.Name = "FormOmronUdpServer";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			Text = "欧姆龙虚拟服务器【数据支持，D,H,A,W,C】";
