...
{
	public class FormRkcTemperatureController : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				TemperatureController temperatureController = rkc;
				if (temperatureController != null)
				{
					temperatureController.Close();
				}
				rkc = new TemperatureController();
				rkc.LogNet = base.LogNet;
				try
				{
					rkc.SerialPortInni(delegate(SerialPort sp)
					{
					...
					panel2.Enabled = true;
					userControlReadWriteOp1.SetReadWriteNet(rkc, "M1");
		...
		{
			OperateResult<byte[]> operateResult = rkc.ReadFromCoreServer(SoftBasic.HexStringToBytes(textBox13.Text));
		...
		private void InitializeComponent()
		{
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(1001, 63);
			panel1.TabIndex = 0;
			...
			comboBox2.Location = new System.Drawing.Point(518, 3);
			...
			label29.TabIndex = 29;
			label29.Text = "Com口：";
			label22.Location = new System.Drawing.Point(889, 5);
			label22.Name = "label22";
			label22.Size = new System.Drawing.Size(107, 49);
			label22.TabIndex = 7;
			label22.Text = "M1, M2";
			...
			label21.Text = "地址示例：";
			button2.Enabled = false;
			button2.Location = new System.Drawing.Point(710, 23);
			...
			groupBox4.Size = new System.Drawing.Size(536, 134);
			...
			textBox11.Size = new System.Drawing.Size(467, 66);
			...
			label14.TabIndex = 9;
			label14.Text = "结果：";
			button26.Location = new System.Drawing.Point(448, 24);
			...
			textBox13.Size = new System.Drawing.Size(379, 23);
			...
			groupBox3.Size = new System.Drawing.Size(536, 154);
			...
			textBox10.Size = new System.Drawing.Size(467, 88);
			...
			userControlHead1.ProtocolInfo = "RKC";
			...
			base.Name = "FormRkcTemperatureController";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "RKC CD/CH数字式温度控制器";
