...
{
	public class FormTurckReaderNet : HslFormContent
	{
		[CompilerGenerated]
		private sealed class _003Cbutton1_Click_003Ed__6 : IAsyncStateMachine
		{
			...
			public FormTurckReaderNet _003C_003E4__this;
			...
			private void MoveNext()
			{
				...
				try
				{
					...
					_003C_003E4__this.reader_net.IpAddress = _003C_003E4__this.textBox1.Text;
					if (int.TryParse(_003C_003E4__this.textBox2.Text, out _003Cport_003E5__1))
					{
						_003C_003E4__this.reader_net.Port = _003Cport_003E5__1;
						_003C_003E4__this.reader_net.ConnectClose();
						_003C_003E4__this.reader_net.LogNet = _003C_003E4__this.LogNet;
						_003C_003E4__this.button1.Enabled = false;
						_003C_003E4__this.reader_net.ConnectTimeOut = 3000;
						awaiter = _003C_003E4__this.reader_net.ConnectServerAsync().GetAwaiter();
					...
					if (_003Cconnect_003E5__2.IsSuccess)
					{
						...
						_003C_003E4__this.userControlReadWriteOp1.SetReadWriteNet(_003C_003E4__this.reader_net, "100");
					}
					else
					{
						MessageBox.Show(_003Cconnect_003E5__2.Message + Environment.NewLine + "ErrorCode: " + _003Cconnect_003E5__2.ErrorCode.ToString());
		...
		{
			OperateResult<byte[]> operateResult = reader_net.ReadFromCoreServer(SoftBasic.HexStringToBytes(textBox13.Text));
		...
		{
			OperateResult<string> operateResult = reader_net.ReadRFIDInfo();
			if (operateResult.IsSuccess)
			{
				label2.Text = "UID: " + reader_net.UID;
				label4.Text = "BytesOfBlock: " + reader_net.BytesOfBlock.ToString();
				label5.Text = "NumberOfBlock: " + reader_net.NumberOfBlock.ToString();
			}
			else
			{
		...
		private void InitializeComponent()
		{
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(1015, 42);
			panel1.TabIndex = 0;
			button2.Enabled = false;
			...
			panel2.Name = "panel2";
			panel2.Size = new System.Drawing.Size(1015, 568);
			panel2.TabIndex = 1;
			...
			userControlReadWriteOp1.Size = new System.Drawing.Size(1009, 235);
			...
			groupBox5.Location = new System.Drawing.Point(591, 243);
			...
			textBox3.Size = new System.Drawing.Size(388, 215);
			textBox3.TabIndex = 26;
			button7.Location = new System.Drawing.Point(303, 18);
			button7.Name = "button7";
			button7.Size = new System.Drawing.Size(101, 34);
			button7.TabIndex = 24;
			button7.Text = "Read 载码体";
			...
			groupBox4.Size = new System.Drawing.Size(584, 153);
			...
			textBox11.Size = new System.Drawing.Size(515, 87);
			...
			button25.Location = new System.Drawing.Point(506, 24);
			...
			textBox9.Location = new System.Drawing.Point(414, 27);
			textBox9.Name = "textBox9";
			textBox9.Size = new System.Drawing.Size(84, 23);
			textBox9.TabIndex = 7;
			textBox9.Text = "10";
			label12.Anchor = (System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right);
			label12.AutoSize = true;
			label12.Location = new System.Drawing.Point(374, 30);
			...
			textBox6.Size = new System.Drawing.Size(305, 23);
			textBox6.TabIndex = 5;
			textBox6.Text = "100";
			...
			userControlHead1.ProtocolInfo = "Reader";
			userControlHead1.Size = new System.Drawing.Size(1022, 32);
			...
			AutoScroll = true;
			base.ClientSize = new System.Drawing.Size(1022, 652);
			base.Controls.Add(userControlHead1);
			base.Controls.Add(panel2);
			base.Controls.Add(panel1);
			Font = new System.Drawing.Font("微软雅黑", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
			base.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			base.Name = "FormTurckReaderNet";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "Turck Reader访问Demo";
