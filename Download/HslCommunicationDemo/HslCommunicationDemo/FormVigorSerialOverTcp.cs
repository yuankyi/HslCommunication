...
{
	public class FormVigorSerialOverTcp : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				VigorSerialOverTcp vigorSerialOverTcp = vigor;
				if (vigorSerialOverTcp != null)
				{
					vigorSerialOverTcp.ConnectClose();
				}
				vigor = new VigorSerialOverTcp();
				...
				try
				{
					...
					OperateResult operateResult = vigor.ConnectServer();
		...
		private void InitializeComponent()
		{
			...
			userControlHead1.ProtocolInfo = "Vigor Serial OverTcp";
			...
			base.Name = "FormVigorSerialOverTcp";
