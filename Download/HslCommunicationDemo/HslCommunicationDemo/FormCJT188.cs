...
{
	public class FormCJT188 : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				...
				try
				{
					cjt188.SerialPortInni(delegate(SerialPort sp)
					{
					...
					panel2.Enabled = true;
					userControlReadWriteOp1.SetReadWriteNet(cjt188, "90-1F");
				}
				catch (Exception ex)
				{
		...
		private void button25_Click(object sender, EventArgs e)
		{
			try
			{
				OperateResult<byte[]> operateResult = cjt188.Read(textBox6.Text, ushort.Parse(textBox9.Text));
		...
		{
			OperateResult operateResult = cjt188.ActiveDeveice();
			if (operateResult.IsSuccess)
			{
		...
		private void InitializeComponent()
		{
			...
			label5.Location = new System.Drawing.Point(950, 6);
			label5.Name = "label5";
			label5.Size = new System.Drawing.Size(32, 17);
			label5.TabIndex = 45;
			label5.Text = "HEX";
			textBox_type.Location = new System.Drawing.Point(893, 3);
			textBox_type.Name = "textBox_type";
			textBox_type.Size = new System.Drawing.Size(48, 23);
			textBox_type.TabIndex = 44;
			textBox_type.Text = "19";
			label4.AutoSize = true;
			label4.Location = new System.Drawing.Point(825, 6);
			label4.Name = "label4";
			label4.Size = new System.Drawing.Size(56, 17);
			label4.TabIndex = 43;
			label4.Text = "表类型：";
			checkBox_enable_Fe.AutoSize = true;
			checkBox_enable_Fe.Location = new System.Drawing.Point(723, 5);
			...
			userControlHead1.ProtocolInfo = "CJT188 2004";
