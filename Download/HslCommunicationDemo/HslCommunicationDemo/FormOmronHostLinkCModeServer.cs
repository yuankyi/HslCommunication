...
{
	public class FormOmronHostLinkCModeServer : HslFormContent
	{
		private OmronHostLinkCModeServer omronFinsServer;
		...
		{
			InitializeComponent();
			omronFinsServer = new OmronHostLinkCModeServer();
		...
		{
			OmronHostLinkCModeServer omronHostLinkCModeServer = omronFinsServer;
			if (omronHostLinkCModeServer != null)
			{
				omronHostLinkCModeServer.ServerClose();
			}
		}
		...
		private void button11_Click(object sender, EventArgs e)
		{
			...
			if (omronHostLinkCModeServer != null)
			{
				omronHostLinkCModeServer.CloseSerialSlave();
			}
			OmronHostLinkCModeServer omronHostLinkCModeServer2 = omronFinsServer;
			if (omronHostLinkCModeServer2 != null)
			{
				omronHostLinkCModeServer2.ServerClose();
			}
		...
		private void InitializeComponent()
		{
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(997, 56);
			panel1.TabIndex = 0;
			...
			button5.Location = new System.Drawing.Point(579, 1);
			...
			userControlHead1.ProtocolInfo = "Fins - HostLink - CMode";
			userControlHead1.Size = new System.Drawing.Size(1004, 32);
			userControlHead1.TabIndex = 2;
			userControlHead1.SaveConnectEvent += new System.EventHandler<System.EventArgs>(userControlHead1_SaveConnectEvent_1);
			label4.AutoSize = true;
			label4.Location = new System.Drawing.Point(430, 32);
			label4.Name = "label4";
			label4.Size = new System.Drawing.Size(44, 17);
			label4.TabIndex = 36;
			label4.Text = "参数：";
			textBox1.Location = new System.Drawing.Point(481, 30);
			...
			base.Name = "FormOmronHostLinkCModeServer";
