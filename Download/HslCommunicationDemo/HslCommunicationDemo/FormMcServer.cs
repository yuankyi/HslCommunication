...
{
	public class FormMcServer : HslFormContent
	{
		private MelsecMcServer mcNetServer;
		...
		{
			MelsecMcServer melsecMcServer = mcNetServer;
			if (melsecMcServer != null)
			{
				melsecMcServer.ServerClose();
			}
		}
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				try
				{
					mcNetServer = new MelsecMcServer(checkBox2.Checked);
		...
		private void InitializeComponent()
		{
			...
			checkBox2.Location = new System.Drawing.Point(74, 34);
			...
			button11.Enabled = false;
			button11.Location = new System.Drawing.Point(235, 3);
			...
			button1.Location = new System.Drawing.Point(145, 3);
			...
			userControlHead1.ProtocolInfo = "MC Qna3E Server";
