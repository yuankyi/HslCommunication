...
{
	public class FormInovanceSerialOverTcp : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				InovanceSerialOverTcp inovanceSerialOverTcp = inovance;
				if (inovanceSerialOverTcp != null)
				{
					inovanceSerialOverTcp.ConnectClose();
				}
				inovance = new InovanceSerialOverTcp(textBox1.Text, result, result2);
				...
				try
				{
					OperateResult operateResult = inovance.ConnectServer();
					if (operateResult.IsSuccess)
					{
						...
						panel2.Enabled = true;
						userControlReadWriteOp1.SetReadWriteNet(inovance, "M100", true);
					}
					else
					{
		...
		{
			OperateResult<byte[]> operateResult = inovance.ReadFromCoreServer(SoftBasic.HexStringToBytes(textBox13.Text));
			if (operateResult.IsSuccess)
			{
		...
		private void thread_test2()
		{
			...
			{
				if (!inovance.Write("100", (short)1234).IsSuccess)
				{
					failed++;
				}
				if (!inovance.ReadInt16("100").IsSuccess)
				{
					failed++;
				}
			}
		...
		private void InitializeComponent()
		{
			...
			comboBox4.Location = new System.Drawing.Point(367, 31);
			...
			label2.TabIndex = 37;
			label2.Text = "系列：";
			button1.Location = new System.Drawing.Point(772, 12);
			...
			comboBox1.Location = new System.Drawing.Point(558, 3);
			comboBox1.Name = "comboBox1";
			comboBox1.Size = new System.Drawing.Size(78, 25);
			...
			textBox15.Location = new System.Drawing.Point(392, 4);
			textBox15.Name = "textBox15";
			textBox15.Size = new System.Drawing.Size(39, 23);
			textBox15.TabIndex = 7;
			textBox15.Text = "1";
			label21.AutoSize = true;
			label21.Location = new System.Drawing.Point(338, 7);
			label21.Name = "label21";
			label21.Size = new System.Drawing.Size(44, 17);
			label21.TabIndex = 6;
			label21.Text = "站号：";
			button2.Enabled = false;
			button2.Location = new System.Drawing.Point(875, 12);
			...
			checkBox3.Location = new System.Drawing.Point(653, 6);
			...
			groupBox5.Size = new System.Drawing.Size(419, 292);
			...
			groupBox4.Size = new System.Drawing.Size(564, 132);
			...
			userControlHead1.ProtocolInfo = "Modbus RtuOverTcp";
			...
			base.Name = "FormInovanceSerialOverTcp";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "InovanceSerialOverTcp访问Demo";
