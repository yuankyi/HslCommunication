...
{
	public class FormMcUdpServer : HslFormContent
	{
		private MelsecMcUdpServer mcNetServer;
		...
		{
			MelsecMcUdpServer melsecMcUdpServer = mcNetServer;
			if (melsecMcUdpServer != null)
			{
				melsecMcUdpServer.ServerClose();
			}
		}
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				try
				{
					mcNetServer = new MelsecMcUdpServer(checkBox2.Checked);
		...
		private void InitializeComponent()
		{
			...
			checkBox2.Location = new System.Drawing.Point(74, 40);
			checkBox2.Name = "checkBox2";
			checkBox2.Size = new System.Drawing.Size(63, 21);
			checkBox2.TabIndex = 30;
			checkBox2.Text = "Binary";
			...
			userControlReadWriteServer1.Location = new System.Drawing.Point(3, 4);
			...
			userControlHead1.ProtocolInfo = "MC Qna3E Udp Server";
