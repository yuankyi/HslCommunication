...
{
	public class FormDLT645With1997 : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				DLT645With1997 dLT645With = dLT645;
				if (dLT645With != null)
				{
					dLT645With.Close();
				}
				...
				try
				{
					...
					panel2.Enabled = true;
					userControlReadWriteOp1.SetReadWriteNet(dLT645, "B6-11");
				}
				catch (Exception ex)
				{
		...
		private void InitializeComponent()
		{
			...
			userControlHead1.ProtocolInfo = "DLT 645 1997";
			...
			base.Name = "FormDLT645With1997";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "DLT645-1997访问Demo";
