...
{
	public class FormFujiSPHServer : HslFormContent
	{
		...
		{
			FujiSPHServer obj = fujiSPHServer;
			if (obj != null)
			{
				obj.ServerClose();
			}
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				try
				{
					fujiSPHServer = new FujiSPHServer();
					fujiSPHServer.ActiveTimeSpan = TimeSpan.FromHours(1.0);
					fujiSPHServer.OnDataReceived += MelsecMcServer_OnDataReceived;
					fujiSPHServer.ServerStart(result);
		...
		private void InitializeComponent()
		{
			...
			label11.Location = new System.Drawing.Point(343, 3);
			label11.Name = "label11";
			label11.Size = new System.Drawing.Size(447, 41);
			label11.TabIndex = 29;
			label11.Text = "本服务器不是严格的SPH协议，仅支持和HSL组件完美通信。";
			button11.Enabled = false;
			...
			userControlReadWriteServer1.Size = new System.Drawing.Size(994, 550);
			...
			userControlHead1.ProtocolInfo = "Fuji SPH";
			...
			base.Name = "FormFujiSPHServer";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			Text = "富士SPH虚拟服务器【数据支持M1.0, M3.0, M10.0, I0, Q0】";
