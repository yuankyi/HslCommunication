...
{
	public class FormBeckhoffAdsServer : HslFormContent
	{
		...
		{
			BeckhoffAdsServer beckhoffAdsServer = adsServer;
			if (beckhoffAdsServer != null)
			{
				beckhoffAdsServer.ServerClose();
			}
		}
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				try
				{
					adsServer = new BeckhoffAdsServer();
					adsServer.ActiveTimeSpan = TimeSpan.FromHours(1.0);
		...
		private void InitializeComponent()
		{
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(997, 52);
			panel1.TabIndex = 0;
			...
			label11.TabIndex = 29;
			label11.Text = "本服务器不是严格的ADS协议，仅支持和HSL组件完美通信。";
			button11.Enabled = false;
			...
			textBox2.Location = new System.Drawing.Point(66, 11);
			...
			userControlReadWriteServer1.Location = new System.Drawing.Point(3, 22);
			userControlReadWriteServer1.Name = "userControlReadWriteServer1";
			userControlReadWriteServer1.Size = new System.Drawing.Size(989, 523);
			...
			userControlHead1.ProtocolInfo = "Ads Server";
			...
			label1.Name = "label1";
			label1.Size = new System.Drawing.Size(690, 17);
			label1.TabIndex = 3;
			label1.Text = "预设地址：s=MAIN.a (short)     s=MAIN.cc (int)    s=MAIN.dd (float)     s=MAIN.ee  (boo[11])     s=MAIN.ff  (short[3])";
			...
			base.Name = "FormBeckhoffAdsServer";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			Text = "倍福ADS虚拟服务器【数据支持M0，I0, Q0】";
