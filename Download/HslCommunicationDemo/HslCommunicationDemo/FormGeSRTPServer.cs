...
{
	public class FormGeSRTPServer : HslFormContent
	{
		private GeSRTPServer geSRTPServer;
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				try
				{
					geSRTPServer = new GeSRTPServer();
					geSRTPServer.ActiveTimeSpan = TimeSpan.FromHours(1.0);
					geSRTPServer.OnDataReceived += BusTcpServer_OnDataReceived;
					geSRTPServer.ServerStart(result);
		...
		private void InitializeComponent()
		{
			...
			label11.TabIndex = 29;
			label11.Text = "本服务器不是严格的GE SRTP协议，仅支持和HSL组件完美通信。";
			button11.Enabled = false;
			...
			userControlReadWriteServer1.Size = new System.Drawing.Size(989, 549);
			...
			base.Name = "FormGeSRTPServer";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			Text = "GE SRTP虚拟服务器【数据支持I,Q,M,T,SA,SB,SC,S,G,AI,AQ,R】";
