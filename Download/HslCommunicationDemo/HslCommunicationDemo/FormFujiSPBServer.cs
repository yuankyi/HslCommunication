...
{
	public class FormFujiSPBServer : HslFormContent
	{
		...
		{
			FujiSPBServer fujiSPBServer = sPBServer;
			if (fujiSPBServer != null)
			{
				fujiSPBServer.ServerClose();
			}
		}
		...
		private void InitializeComponent()
		{
			...
			checkBox3.Location = new System.Drawing.Point(793, 16);
			...
			textBox10.Text = "COM1-9600-8-N-1";
			...
			userControlHead1.ProtocolInfo = "FujiSPB Tcp + Serial";
			...
			base.Name = "FormFujiSPBServer";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			Text = "富士SPB虚拟PLC【支持网口和串口】";
