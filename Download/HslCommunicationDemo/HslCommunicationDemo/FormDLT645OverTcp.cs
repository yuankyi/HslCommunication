...
{
	public class FormDLT645OverTcp : HslFormContent
	{
		[CompilerGenerated]
		private sealed class _003Cbutton3_Click_003Ed__9 : IAsyncStateMachine
		{
			...
			public FormDLT645OverTcp _003C_003E4__this;
		...
		private sealed class _003Cbutton4_Click_003Ed__10 : IAsyncStateMachine
		{
			...
			private void MoveNext()
			{
				...
				try
				{
					...
					if (num != 0)
					{
						awaiter = _003C_003E4__this.dLT645.ReadAddressAsync().GetAwaiter();
						if (!awaiter.IsCompleted)
						{
							num = (_003C_003E1__state = 0);
							_003C_003Eu__1 = awaiter;
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				DLT645OverTcp dLT645OverTcp = dLT645;
				if (dLT645OverTcp != null)
				{
					dLT645OverTcp.ConnectClose();
				}
				dLT645 = new DLT645OverTcp(textBox_ip.Text, result, textBox_station.Text, textBox_password.Text, textBox_op_code.Text);
