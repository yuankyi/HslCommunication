...
{
	public class FormOmronServer : HslFormContent
	{
		private OmronFinsServer omronFinsServer;
		...
		{
			OmronFinsServer obj = omronFinsServer;
			if (obj != null)
			{
				obj.ServerClose();
			}
		...
		private void InitializeComponent()
		{
			...
			userControlHead1.ProtocolInfo = "Fins Tcp Server";
