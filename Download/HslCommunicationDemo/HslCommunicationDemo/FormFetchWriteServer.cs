...
{
	public class FormFetchWriteServer : HslFormContent
	{
		private SiemensFetchWriteServer s7NetServer;
		...
		{
			SiemensFetchWriteServer siemensFetchWriteServer = s7NetServer;
			if (siemensFetchWriteServer != null)
			{
				siemensFetchWriteServer.ServerClose();
			}
		}
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				try
				{
					s7NetServer = new SiemensFetchWriteServer();
		...
		private void InitializeComponent()
		{
			...
			base.Name = "FormFetchWriteServer";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			Text = "西门子FetchWrite虚拟服务器【数据支持I，Q，M，T，C，DB1,DB2,DB3块读写，其他DB块共享一个数据区】";
