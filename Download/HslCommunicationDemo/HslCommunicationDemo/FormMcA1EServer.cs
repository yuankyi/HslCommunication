...
{
	public class FormMcA1EServer : HslFormContent
	{
		private MelsecA1EServer mcNetServer;
		...
		{
			MelsecA1EServer melsecA1EServer = mcNetServer;
			if (melsecA1EServer != null)
			{
				melsecA1EServer.ServerClose();
			}
		}
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				try
				{
					mcNetServer = new MelsecA1EServer(radioButton1.Checked);
		...
		private void InitializeComponent()
		{
			...
			label11.Location = new System.Drawing.Point(334, 2);
			label11.Name = "label11";
			label11.Size = new System.Drawing.Size(447, 41);
			label11.TabIndex = 29;
			label11.Text = "本服务器不是严格的mc协议，仅支持和HSL组件完美通信。";
			button11.Enabled = false;
			button11.Location = new System.Drawing.Point(226, 6);
			...
			button1.Location = new System.Drawing.Point(136, 6);
			...
			textBox2.Location = new System.Drawing.Point(65, 9);
			...
			userControlReadWriteServer1.Size = new System.Drawing.Size(990, 527);
			...
			userControlHead1.ProtocolInfo = "MC A1E Server";
			userControlHead1.Size = new System.Drawing.Size(1004, 32);
			userControlHead1.TabIndex = 2;
			userControlHead1.SaveConnectEvent += new System.EventHandler<System.EventArgs>(userControlHead1_SaveConnectEvent_1);
			label1.AutoSize = true;
			label1.Location = new System.Drawing.Point(11, 40);
			label1.Name = "label1";
			...
			radioButton1.Location = new System.Drawing.Point(85, 38);
			radioButton1.Name = "radioButton1";
			radioButton1.Size = new System.Drawing.Size(62, 21);
			radioButton1.TabIndex = 32;
			radioButton1.TabStop = true;
			radioButton1.Text = "Binary";
			radioButton1.UseVisualStyleBackColor = true;
			radioButton2.AutoSize = true;
			radioButton2.Location = new System.Drawing.Point(157, 38);
			...
			base.Name = "FormMcA1EServer";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			Text = "mc虚拟服务器【数据支持，bool是M,X,Y，字操作是x,y,m,d,w】";
