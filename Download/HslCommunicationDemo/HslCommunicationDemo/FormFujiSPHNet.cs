...
{
	public class FormFujiSPHNet : HslFormContent
	{
		...
		private void ComboBox1_SelectedIndexChanged(object sender, EventArgs e)
		{
			if (fujiSPB != null)
			{
				...
				DataFormat dataFormat = default(DataFormat);
				int num;
				if (selectedItem is DataFormat)
				{
					dataFormat = (DataFormat)selectedItem;
					num = 1;
				}
				else
				{
				...
				if (num != 0)
				{
					fujiSPB.ByteTransform.DataFormat = dataFormat;
				}
			}
		}
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				FujiSPHNet fujiSPHNet = fujiSPB;
				if (fujiSPHNet != null)
				{
					fujiSPHNet.ConnectClose();
				}
				fujiSPB = new FujiSPHNet();
				fujiSPB.IpAddress = textBox1.Text;
				fujiSPB.Port = result;
				fujiSPB.LogNet = base.LogNet;
				try
				{
					fujiSPB.ConnectionID = byte.Parse(textBox15.Text);
					OperateResult operateResult = fujiSPB.ConnectServer();
		...
		{
			OperateResult<byte[]> operateResult = fujiSPB.ReadFromCoreServer(SoftBasic.HexStringToBytes(textBox13.Text));
			if (operateResult.IsSuccess)
			{
		...
		private void test3()
		{
			short content = fujiSPB.ReadInt16("D100").Content;
			ushort content2 = fujiSPB.ReadUInt16("D100").Content;
			int content3 = fujiSPB.ReadInt32("D100").Content;
			uint content4 = fujiSPB.ReadUInt32("D100").Content;
			long content5 = fujiSPB.ReadInt64("D100").Content;
			ulong content6 = fujiSPB.ReadUInt64("D100").Content;
			float content7 = fujiSPB.ReadFloat("D100").Content;
			double content8 = fujiSPB.ReadDouble("D100").Content;
			string content9 = fujiSPB.ReadString("D100", 10).Content;
		}
		...
		private void test4()
		{
			...
			fujiSPB.Write("D100", 5u);
			fujiSPB.Write("D100", 5L);
			fujiSPB.Write("D100", 5uL);
			fujiSPB.Write("D100", 5f);
			fujiSPB.Write("D100", 5.0);
			fujiSPB.Write("D100", "12345678");
		}

		private void test5()
		{
			OperateResult<byte[]> operateResult = fujiSPB.Read("D100", 10);
			if (operateResult.IsSuccess)
			{
				int num = fujiSPB.ByteTransform.TransInt32(operateResult.Content, 0);
				float num2 = fujiSPB.ByteTransform.TransSingle(operateResult.Content, 4);
				short num3 = fujiSPB.ByteTransform.TransInt16(operateResult.Content, 8);
		...
		private void test6()
		{
			OperateResult<UserType> operateResult = fujiSPB.ReadCustomer<UserType>("D100");
			if (operateResult.IsSuccess)
			{
				UserType content = operateResult.Content;
			}
			fujiSPB.WriteCustomer("D100", new UserType());
			fujiSPB.LogNet = new LogNetSingle(Application.StartupPath + "\\Logs.txt");
		}
		...
		private void InitializeComponent()
		{
			...
			comboBox1.Location = new System.Drawing.Point(590, 9);
			comboBox1.Name = "comboBox1";
			comboBox1.Size = new System.Drawing.Size(121, 25);
			comboBox1.TabIndex = 30;
			label1.AutoSize = true;
			label1.Location = new System.Drawing.Point(505, 12);
			label1.Name = "label1";
			label1.Size = new System.Drawing.Size(79, 17);
			label1.TabIndex = 29;
			label1.Text = "DataFormat:";
			textBox15.Location = new System.Drawing.Point(414, 9);
			textBox15.Name = "textBox15";
			textBox15.Size = new System.Drawing.Size(75, 23);
			textBox15.TabIndex = 28;
			textBox15.Text = "254";
			label21.AutoSize = true;
			label21.Location = new System.Drawing.Point(315, 12);
			label21.Name = "label21";
			label21.Size = new System.Drawing.Size(101, 17);
			label21.TabIndex = 27;
			label21.Text = "Connection Id：";
			...
			label27.Text = "Ip地址：";
			button2.Enabled = false;
			button2.Location = new System.Drawing.Point(814, 6);
			...
			button1.Location = new System.Drawing.Point(717, 6);
			...
			groupBox5.Location = new System.Drawing.Point(569, 243);
			groupBox5.Name = "groupBox5";
			groupBox5.Size = new System.Drawing.Size(419, 304);
			...
			groupBox4.Size = new System.Drawing.Size(560, 144);
			...
			textBox11.Size = new System.Drawing.Size(483, 78);
			...
			button26.Location = new System.Drawing.Point(464, 24);
			...
			textBox13.Size = new System.Drawing.Size(395, 23);
			...
			groupBox3.Size = new System.Drawing.Size(560, 154);
			...
			textBox10.Size = new System.Drawing.Size(491, 88);
			...
			button25.Location = new System.Drawing.Point(464, 24);
			...
			userControlHead1.ProtocolInfo = "SPH Net";
			...
			AutoScroll = true;
			base.ClientSize = new System.Drawing.Size(1004, 647);
			base.Controls.Add(userControlHead1);
			base.Controls.Add(panel2);
			base.Controls.Add(panel1);
			Font = new System.Drawing.Font("微软雅黑", 9f, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, 134);
			base.Margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
			base.Name = "FormFujiSPHNet";
