...
{
	public class FormDLT698OverTcp : HslFormContent
	{
		[CompilerGenerated]
		private sealed class _003Cbutton3_Click_003Ed__9 : IAsyncStateMachine
		{
			...
			public FormDLT698OverTcp _003C_003E4__this;
			...
			private void MoveNext()
			{
				...
				try
				{
					...
					if (num != 0)
					{
						awaiter = _003C_003E4__this.dLT698.ActiveDeveiceAsync().GetAwaiter();
		...
		private sealed class _003Cbutton4_Click_003Ed__10 : IAsyncStateMachine
		{
			...
			private void MoveNext()
			{
				...
				try
				{
					...
					if (num != 0)
					{
						awaiter = _003C_003E4__this.dLT698.ReadAddressAsync().GetAwaiter();
						if (!awaiter.IsCompleted)
						{
							num = (_003C_003E1__state = 0);
							_003C_003Eu__1 = awaiter;
					...
					{
						_003C_003E4__this.textBox_station.Text = _003Cread_003E5__1.Content;
						_003C_003E4__this.textBox12.Text = string.Format("[{0:HH:mm:ss}] Address:{1}", DateTime.Now, _003Cread_003E5__1.Content);
					}
					else
					{
		...
		private sealed class _003Cbutton5_Click_003Ed__12 : IAsyncStateMachine
		{
			...
			private void MoveNext()
			{
				...
				try
				{
					...
					if (num != 0)
					{
						awaiter = _003C_003E4__this.dLT698.WriteAddressAsync(_003C_003E4__this.textBox1.Text).GetAwaiter();
						if (!awaiter.IsCompleted)
						{
							num = (_003C_003E1__state = 0);
							_003C_003Eu__1 = awaiter;
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				DLT698OverTcp dLT698OverTcp = dLT698;
				if (dLT698OverTcp != null)
				{
					dLT698OverTcp.ConnectClose();
				}
				dLT698 = new DLT698OverTcp(textBox_ip.Text, result, textBox_station.Text);
				dLT698.LogNet = base.LogNet;
				dLT698.EnableCodeFE = checkBox_enable_Fe.Checked;
				try
				{
					OperateResult operateResult = dLT698.ConnectServer();
		...
		private void InitializeComponent()
		{
			...
			label13.TabIndex = 9;
			label13.Text = "结果：";
			button25.Location = new System.Drawing.Point(443, 24);
			...
			userControlHead1.ProtocolInfo = "DLT 698.45 Over Tcp";
