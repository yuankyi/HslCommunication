...
{
	public class FormDLT698TcpNet : HslFormContent
	{
		[CompilerGenerated]
		private sealed class _003Cbutton3_Click_003Ed__9 : IAsyncStateMachine
		{
			...
			public FormDLT698TcpNet _003C_003E4__this;
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				DLT698TcpNet dLT698TcpNet = dLT698;
				if (dLT698TcpNet != null)
				{
					dLT698TcpNet.ConnectClose();
				}
				dLT698 = new DLT698TcpNet(textBox_ip.Text, result, textBox_station.Text);
		...
		private void InitializeComponent()
		{
			...
			userControlHead1.ProtocolInfo = "DLT 698.45 TcpNet";
