...
{
	public class FormXinJEInternalTcp : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				XinJEInternalNet xinJEInternalNet = xinJE;
				if (xinJEInternalNet != null)
				{
					xinJEInternalNet.ConnectClose();
				}
				xinJE = new XinJEInternalNet();
		...
		private void test3()
		{
			short content = xinJE.ReadInt16("D100").Content;
			ushort content2 = xinJE.ReadUInt16("D100").Content;
			int content3 = xinJE.ReadInt32("D100").Content;
			uint content4 = xinJE.ReadUInt32("D100").Content;
			long content5 = xinJE.ReadInt64("D100").Content;
			ulong content6 = xinJE.ReadUInt64("D100").Content;
			float content7 = xinJE.ReadFloat("D100").Content;
			double content8 = xinJE.ReadDouble("D100").Content;
			string content9 = xinJE.ReadString("D100", 10).Content;
		}
		...
		private void test4()
		{
			...
			xinJE.Write("D100", 5u);
			xinJE.Write("D100", 5L);
			xinJE.Write("D100", 5uL);
			xinJE.Write("D100", 5f);
			xinJE.Write("D100", 5.0);
			xinJE.Write("D100", "12345678");
		}

		private void test5()
		{
			OperateResult<byte[]> operateResult = xinJE.Read("D100", 10);
			if (operateResult.IsSuccess)
			{
				int num = xinJE.ByteTransform.TransInt32(operateResult.Content, 0);
				float num2 = xinJE.ByteTransform.TransSingle(operateResult.Content, 4);
				short num3 = xinJE.ByteTransform.TransInt16(operateResult.Content, 8);
		...
		private void test6()
		{
			OperateResult<UserType> operateResult = xinJE.ReadCustomer<UserType>("D100");
			if (operateResult.IsSuccess)
			{
				UserType content = operateResult.Content;
			}
			xinJE.WriteCustomer("D100", new UserType());
			xinJE.LogNet = new LogNetSingle(Application.StartupPath + "\\Logs.txt");
		}
		...
		private void InitializeComponent()
		{
			...
			label_station = new System.Windows.Forms.Label();
			...
			panel1.Controls.Add(label_station);
			...
			panel1.TabIndex = 0;
			textBox_station.Location = new System.Drawing.Point(400, 9);
			textBox_station.Name = "textBox_station";
			textBox_station.Size = new System.Drawing.Size(79, 23);
			textBox_station.TabIndex = 28;
			textBox_station.Text = "0";
			label_station.AutoSize = true;
			label_station.Location = new System.Drawing.Point(337, 12);
			label_station.Name = "label_station";
			label_station.Size = new System.Drawing.Size(44, 17);
			label_station.TabIndex = 27;
			label_station.Text = "站号：";
			textBox2.Location = new System.Drawing.Point(271, 9);
			textBox2.Name = "textBox2";
			textBox2.Size = new System.Drawing.Size(47, 23);
			textBox2.TabIndex = 19;
			textBox2.Text = "502";
			label26.AutoSize = true;
			label26.Location = new System.Drawing.Point(222, 12);
			...
			groupBox4.Size = new System.Drawing.Size(557, 145);
			...
			textBox11.Size = new System.Drawing.Size(488, 79);
			...
			textBox13.Size = new System.Drawing.Size(400, 23);
			...
			userControlHead1.ProtocolInfo = "内部 TCP 协议";
			...
			base.Name = "FormXinJEInternalTcp";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "XINJE PLC访问Demo";
