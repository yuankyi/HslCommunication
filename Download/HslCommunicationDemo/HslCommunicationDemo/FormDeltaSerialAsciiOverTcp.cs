...
{
	public class FormDeltaSerialAsciiOverTcp : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				DeltaSerialAsciiOverTcp deltaSerialAsciiOverTcp = delta;
				if (deltaSerialAsciiOverTcp != null)
				{
					deltaSerialAsciiOverTcp.ConnectClose();
				}
				delta = new DeltaSerialAsciiOverTcp(textBox1.Text, result, result2);
				delta.LogNet = base.LogNet;
				delta.Series = (DeltaSeries)comboBox1.SelectedItem;
				try
				{
					OperateResult operateResult = delta.ConnectServer();
					if (operateResult.IsSuccess)
					{
						...
						panel2.Enabled = true;
						userControlReadWriteOp1.SetReadWriteNet(delta, "D100", true);
					}
					else
					{
		...
		{
			OperateResult<byte[]> operateResult = delta.ReadFromCoreServer(SoftBasic.HexStringToBytes(textBox13.Text));
			if (operateResult.IsSuccess)
			{
		...
		private void thread_test2()
		{
			...
			{
				if (!delta.Write("100", (short)1234).IsSuccess)
				{
					failed++;
				}
				if (!delta.ReadInt16("100").IsSuccess)
				{
					failed++;
				}
			}
		...
		private void InitializeComponent()
		{
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(997, 49);
			panel1.TabIndex = 0;
			comboBox1.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			comboBox1.FormattingEnabled = true;
			comboBox1.Location = new System.Drawing.Point(507, 10);
			comboBox1.Name = "comboBox1";
			comboBox1.Size = new System.Drawing.Size(86, 25);
			comboBox1.TabIndex = 11;
			label2.AutoSize = true;
			label2.Location = new System.Drawing.Point(448, 14);
			label2.Name = "label2";
			label2.Size = new System.Drawing.Size(44, 17);
			label2.TabIndex = 10;
			label2.Text = "系列：";
			button1.Location = new System.Drawing.Point(614, 8);
			...
			textBox15.Location = new System.Drawing.Point(392, 11);
			textBox15.Name = "textBox15";
			textBox15.Size = new System.Drawing.Size(39, 23);
			textBox15.TabIndex = 7;
			textBox15.Text = "1";
			label21.AutoSize = true;
			label21.Location = new System.Drawing.Point(338, 14);
			label21.Name = "label21";
			label21.Size = new System.Drawing.Size(44, 17);
			label21.TabIndex = 6;
			label21.Text = "站号：";
			button2.Enabled = false;
			button2.Location = new System.Drawing.Point(717, 8);
			...
			textBox2.Location = new System.Drawing.Point(250, 11);
			textBox2.Name = "textBox2";
			textBox2.Size = new System.Drawing.Size(76, 23);
			textBox2.TabIndex = 3;
			textBox2.Text = "502";
			label3.AutoSize = true;
			label3.Location = new System.Drawing.Point(196, 14);
			label3.Name = "label3";
			label3.Size = new System.Drawing.Size(56, 17);
			label3.TabIndex = 2;
			label3.Text = "端口号：";
			textBox1.Location = new System.Drawing.Point(62, 11);
			...
			groupBox4.Size = new System.Drawing.Size(564, 146);
			...
			textBox11.Size = new System.Drawing.Size(495, 80);
			...
			userControlHead1.ProtocolInfo = "Modbus Ascii Over Tcp";
			...
			base.Name = "FormDeltaSerialAsciiOverTcp";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "DeltaSerialASCIIOverTcp访问Demo";
