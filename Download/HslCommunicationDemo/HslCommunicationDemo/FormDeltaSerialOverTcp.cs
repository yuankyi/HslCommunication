...
{
	public class FormDeltaSerialOverTcp : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				DeltaSerialOverTcp deltaSerialOverTcp = delta;
				if (deltaSerialOverTcp != null)
				{
					deltaSerialOverTcp.ConnectClose();
				}
				delta = new DeltaSerialOverTcp(textBox1.Text, result, result2);
		...
		private void InitializeComponent()
		{
			...
			userControlHead1.ProtocolInfo = "Modbus Rtu Over Tcp";
			...
			base.Name = "FormDeltaSerialOverTcp";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "DeltaSerialOverTcp访问Demo";
