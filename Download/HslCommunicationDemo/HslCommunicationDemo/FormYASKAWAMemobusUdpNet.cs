...
{
	public class FormYASKAWAMemobusUdpNet : HslFormContent
	{
		...
		public FormYASKAWAMemobusUdpNet()
		{
			InitializeComponent();
		}
		...
		{
			ushort[] array = textBox_read_random.Text.ToStringArray<ushort>();
			OperateResult<byte[]> operateResult = memobus.ReadRandom(array);
			if (operateResult.IsSuccess)
			{
				ushort[] value = memobus.ByteTransform.TransUInt16(operateResult.Content, 0, array.Length);
		...
		private void InitializeComponent()
		{
			...
			textBox_random_result.Location = new System.Drawing.Point(74, 93);
			...
			textBox_random_result.TabIndex = 17;
			...
			userControlHead1.ProtocolInfo = "Memobus Udp";
			...
			label5.Location = new System.Drawing.Point(191, 63);
			label5.Name = "label5";
			...
			base.Name = "FormYASKAWAMemobusUdpNet";
