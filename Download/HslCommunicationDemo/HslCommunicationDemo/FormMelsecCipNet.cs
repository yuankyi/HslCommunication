...
{
	public class FormMelsecCipNet : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				...
				cip.Port = result;
				cip.Slot = result2;
				cip.LogNet = base.LogNet;
				try
				{
					OperateResult operateResult = cip.ConnectServer();
		...
		private void button25_Click(object sender, EventArgs e)
		{
			try
			{
				...
				operateResult = (textBox6.Text.Contains(";") ? cip.Read(textBox6.Text.Split(';')) : cip.ReadSegment(textBox6.Text, ushort.Parse(textBox12.Text), ushort.Parse(textBox9.Text)));
				if (operateResult.IsSuccess)
				{
		...
		{
			OperateResult<byte[]> operateResult = cip.ReadCipFromServer(SoftBasic.HexStringToBytes(textBox13.Text));
			if (operateResult.IsSuccess)
			{
		...
		{
			OperateResult<byte[]> operateResult = cip.ReadEipFromServer(SoftBasic.HexStringToBytes(textBox13.Text));
			if (operateResult.IsSuccess)
			{
				textBox11.Text = "Result：" + SoftBasic.ByteToHexString(operateResult.Content);
			}
		...
		{
			OperateResult<bool[]> operateResult = cip.ReadBoolArray(textBox3.Text);
			if (operateResult.IsSuccess)
			{
		...
		private void InitializeComponent()
		{
			...
			panel1.TabIndex = 0;
			textBox15.Location = new System.Drawing.Point(373, 9);
			textBox15.Name = "textBox15";
			textBox15.Size = new System.Drawing.Size(32, 23);
			textBox15.TabIndex = 9;
			textBox15.Text = "0";
			label23.AutoSize = true;
			label23.Location = new System.Drawing.Point(329, 12);
			label23.Name = "label23";
			label23.Size = new System.Drawing.Size(41, 17);
			label23.TabIndex = 8;
			label23.Text = "slot：";
			label22.Location = new System.Drawing.Point(760, 2);
			label22.Name = "label22";
			label22.Size = new System.Drawing.Size(213, 45);
			label22.TabIndex = 7;
			label22.Text = "变量的标签名，bool数组如果是int类型，则带i=开头访问";
			button2.Enabled = false;
			button2.Location = new System.Drawing.Point(559, 6);
			...
			button1.Location = new System.Drawing.Point(466, 6);
			...
			textBox4.Location = new System.Drawing.Point(60, 76);
			textBox4.Multiline = true;
			textBox4.Name = "textBox4";
			textBox4.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
			textBox4.Size = new System.Drawing.Size(341, 186);
			...
			button5.Location = new System.Drawing.Point(276, 36);
			button5.Name = "button5";
			button5.Size = new System.Drawing.Size(125, 28);
			button5.TabIndex = 11;
			button5.Text = "读取";
			button5.UseVisualStyleBackColor = true;
			button5.Click += new System.EventHandler(button5_Click);
			textBox3.Location = new System.Drawing.Point(60, 39);
			textBox3.Name = "textBox3";
			textBox3.Size = new System.Drawing.Size(199, 23);
			...
			groupBox4.Size = new System.Drawing.Size(563, 154);
			...
			button4.Location = new System.Drawing.Point(509, 24);
			...
			textBox11.Size = new System.Drawing.Size(494, 88);
			...
			button26.Location = new System.Drawing.Point(455, 24);
			...
			textBox13.Size = new System.Drawing.Size(386, 23);
			...
			button3.Location = new System.Drawing.Point(475, 24);
			...
			textBox12.Location = new System.Drawing.Point(229, 27);
			textBox12.Name = "textBox12";
			textBox12.Size = new System.Drawing.Size(34, 23);
			...
			label2.TabIndex = 13;
			label2.Text = "起始：";
			textBox9.Location = new System.Drawing.Point(320, 27);
			textBox9.Name = "textBox9";
			textBox9.Size = new System.Drawing.Size(35, 23);
			textBox9.TabIndex = 12;
			textBox9.Text = "1";
			label12.AutoSize = true;
			label12.Location = new System.Drawing.Point(266, 30);
			...
			button25.Location = new System.Drawing.Point(407, 24);
			...
			userControlHead1.ProtocolInfo = "Melsec CIP";
			...
			base.Name = "FormMelsecCipNet";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "Melsec Cip访问Demo";
