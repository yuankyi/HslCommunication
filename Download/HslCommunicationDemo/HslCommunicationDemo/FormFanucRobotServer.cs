...
{
	public class FormFanucRobotServer : HslFormContent
	{
		private FanucRobotServer fanucRobotServer;
		...
		{
			FanucRobotServer obj = fanucRobotServer;
			if (obj != null)
			{
				obj.ServerClose();
			}
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				try
				{
					fanucRobotServer = new FanucRobotServer();
					fanucRobotServer.ActiveTimeSpan = TimeSpan.FromHours(1.0);
					fanucRobotServer.OnDataReceived += BusTcpServer_OnDataReceived;
					fanucRobotServer.ServerStart(result);
		...
		private void InitializeComponent()
		{
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(978, 45);
			panel1.TabIndex = 0;
			...
			label11.TabIndex = 29;
			label11.Text = "本服务器不是严格的fanuc机器人协议，仅支持和HSL组件完美通信。";
			button11.Enabled = false;
			...
			userControlReadWriteServer1.Location = new System.Drawing.Point(6, 6);
			userControlReadWriteServer1.Name = "userControlReadWriteServer1";
			userControlReadWriteServer1.Size = new System.Drawing.Size(960, 526);
			...
			userControlHead1.ProtocolInfo = "fanuc robot";
			...
			base.Name = "FormFanucRobotServer";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			Text = "Fanuc虚拟服务器";
			base.FormClosing += new System.Windows.Forms.FormClosingEventHandler(FormSiemens_FormClosing);
			base.Load += new System.EventHandler(FormFanucRobotServer_Load);
