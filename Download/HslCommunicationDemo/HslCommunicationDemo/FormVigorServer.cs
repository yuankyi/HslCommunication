...
{
	public class FormVigorServer : HslFormContent
	{
		...
		{
			VigorServer vigorServer = sPBServer;
			if (vigorServer != null)
			{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			else
			{
				try
				{
					sPBServer = new VigorServer();
					sPBServer.Station = int.Parse(textBox1.Text);
					sPBServer.ActiveTimeSpan = TimeSpan.FromHours(1.0);
		...
		private void button11_Click(object sender, EventArgs e)
		{
			...
			VigorServer vigorServer2 = sPBServer;
			if (vigorServer2 != null)
			{
				vigorServer2.ServerClose();
			}
		...
		private void InitializeComponent()
		{
			...
			label2.Location = new System.Drawing.Point(556, 30);
			label2.Name = "label2";
			label2.Size = new System.Drawing.Size(91, 17);
			label2.TabIndex = 31;
			label2.Text = "9600,8,1,None";
			...
			button5.Location = new System.Drawing.Point(643, 1);
			...
			textBox10.Location = new System.Drawing.Point(559, 4);
			textBox10.Name = "textBox10";
			textBox10.Size = new System.Drawing.Size(61, 23);
			textBox10.TabIndex = 8;
			textBox10.Text = "COM1";
			label14.AutoSize = true;
			label14.Location = new System.Drawing.Point(492, 7);
			...
			userControlHead1.ProtocolInfo = "Vigor Tcp + Serial";
			...
			base.Name = "FormVigorServer";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			Text = "丰炜虚拟PLC【支持网口和串口】";
