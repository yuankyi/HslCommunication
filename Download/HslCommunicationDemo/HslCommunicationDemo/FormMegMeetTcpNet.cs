...
{
	public class FormMegMeetTcpNet : HslFormContent
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			...
			{
				MegMeetTcpNet megMeetTcpNet = megMeet;
				if (megMeetTcpNet != null)
				{
					megMeetTcpNet.ConnectClose();
				}
				megMeet = new MegMeetTcpNet(textBox1.Text, result, result2);
				...
				try
				{
					...
					if (operateResult.IsSuccess)
					{
						...
						panel2.Enabled = true;
						userControlReadWriteOp1.SetReadWriteNet(megMeet, "D100", true);
					}
					else
					{
		...
		private void InitializeComponent()
		{
			...
			checkBox3.Location = new System.Drawing.Point(653, 15);
			...
			base.Name = "FormMegMeetTcpNet";
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "MegMeetTcp[麦格米特]访问Demo";
